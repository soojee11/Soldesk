...
<form action="insert.do" method="get">
	<input type="button" class="btn btn-default button" value="글쓰기"  onclick="checkLogin(this.form,'${s_id }')"> 
</form>
</div>
<div align="center">
	${paging }<br/>
	<form action ="list.do" >
		...
		<input type="button" class="btn btn-default button" value="검색"  onclick="checkSearch(this.form)">
	</form>
</div>

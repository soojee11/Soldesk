...
<h4>
	...
	<img src="../sol_img/go_right.png" width="20px" /> <img
		src="img/study.png" width="150px" height="50px"><span
		style="font-size: 12px;">| 학습해 보세요 </span>
</h4>
...
<div class="column">
			...
			<tr style="height: auto;">
				<td>
					...
					<div style="font-size: 20px; text-align: center;">
						<img
							src='../sol_admin/player/cateStorage/${cateDto.teacherPhoto }'
							width="300px" height="200px"
							style="margin: 20px; border-radius: 8px; border: 1px solid;" /> <br />${cateDto.teacherName }<br />
						<br />
					</div>
				</td>
				<td>
					...
					<div
						style="text-align: left; margin: 20px; padding: 10px; font-size: 12px;">
						<font style="font-size: 20px">< 선생님 이력 ></font><br />
						<br />${cateDto.teacherCareer }
					</div>
				</td>
			</tr>
		</table>
	...
	<table border="0" width="100%">
		<tr height="10px"></tr>
		<tr>
			<td><div style="font-size: 18px">< 강좌 설명 ></div></td>
		</tr>
		<tr height="10px"></tr>
		<tr>
			<td>
				<div class="view" style="text-align: left; padding-top: 5px;">
					...
					${fn:replace(cateDto.categoryinfo,crlf,'<br/>') }
				</div>
			</td>
		</tr>
		<tr height="10px"></tr>
		<tr>
			<td><div style="font-size: 18px">< 교재 설명 ></div></td>
		</tr>
		<tr height="10px"></tr>
	</table>
	<div style="border: 2px solid #99cc66; width: 98%">
		<table border="0" width="100%">
			<tr>
				<td width="30%">
					<div align="left">
						<img src='../sol_admin/player/cateStorage/${cateDto.bookPhoto }'
							style="margin: 20px">
					</div>
				</td>
				<td width="40%">
				...
				<td align="left">
					<!-- 강좌보러가기 --> <a
					href="lectureList.do?gwamok=${gwamok }&grade=${grade }&tabNum=1">
						<div align="center">
							<font color="green">강좌보러가기</font> <br />

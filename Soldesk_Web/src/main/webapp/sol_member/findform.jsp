...
<form name="findidfrm" 
  ...
  <tr> 
    ...
    <td align="left" valign="middle"  >&nbsp;
      <input type="text" name="name"  style="width:160px; background-color:#f7f4f5;"/>
    </td>
  </tr>
   <tr> 
    <td width="90px" height="20px" align="right">  이메일 </td>
   ...
   <div align="center">
    <input class="btn btn-primary"  type="button" value="아이디찾기" onclick="forgetidcheck(this.form)">
  </div>     
</form>

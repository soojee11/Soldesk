		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="logo span3">
					...
					<a class="brand" href="sol_index.jsp"><img src="sol_img/logo.png" alt="Logo"></a>
	...
	<div class="slider-wrapper">
		...
		<div id="da-slider" class="da-slider">
			<div class="da-slide">
				...
				<div class="da-img"><img src="sol_img/parallax-slider/twitter.png" alt="image01" /></div>
			</div>
			<div class="da-slide">
				<h2>Responsive Design</h2>
				<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
				<a href="#" class="da-link">Read more</a>
				<div class="da-img"><img src="sol_img/parallax-slider/responsive.png" alt="image02" /></div>
			</div>
			<div class="da-slide">
				<h2>HTML5</h2>
				<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
				<a href="#" class="da-link">Read more</a>
				<div class="da-img"><img src="sol_img/parallax-slider/html5.png" alt="image03" /></div>
			</div>
			<div class="da-slide">
				<h2>CSS3</h2>
				<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.</p>
				<a href="#" class="da-link">Read more</a>
				<div class="da-img"><img src="sol_img/parallax-slider/css3.png" alt="image04" /></div>
			</div>
			<nav class="da-arrows">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span3">
					...
					<h3>We are here!</h3>
					<div id="small-map-container"><a href="contact.jsp"></a></div>

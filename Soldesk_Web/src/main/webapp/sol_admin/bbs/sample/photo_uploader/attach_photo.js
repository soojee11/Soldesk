    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/solproject/sol_admin/bbs/multiplePhotoUpload3'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/solproject/sol_admin/bbs/photoUpload3',	//샘플 URL입니다.
 	        sCallback : '/sol_admin/bbs/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
